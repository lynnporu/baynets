...
const localizationStrings = {
	"uk_UA": {
		...
		"file_dump_is_corrupted": "Файл не містить об'єктів для відновлення.",
		"file_json_type": "Файли проєктів",
		"save": "Зберегти",
		"settings": "Налаштування",
		"arrow_delete": "Видалити",
		"arrow_reverse": "Обернути",
		"node_name": "Назва:",
	...
	"en_US": {
		...
		"settings": "Settings",
		"arrow_delete": "Delete",
		"arrow_reverse": "Revere",
		"save_worksheet": "Save worksheet",
		"file_dump_is_corrupted": "File does not contain objects to undump.",
